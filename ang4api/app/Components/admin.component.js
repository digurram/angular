    ...
    AdminComponent.prototype.onSubmit = function (formData) {
        ...
        switch (this.dbops) {
            case enum_1.DBOperation.create:
                this._adminservice.post(global_1.Global.BASE_ADMIN_ENDPOINT, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.update:
                this._adminservice.put(global_1.Global.BASE_ADMIN_ENDPOINT, formData._value.Id, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.delete:
                this._adminservice.delete(global_1.Global.BASE_ADMIN_ENDPOINT, formData._value.Id).subscribe(function (data) {
                    if (data == 1) {
