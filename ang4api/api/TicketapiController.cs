...
namespace ang4api.api
{
    ...
    public class TicketapiController : BaseAPIController
    {
        ...
        public HttpResponseMessage GetfileAttachemnet(int id)
        {
            ...
            try
            {
                ...
                response.Content =  new StringContent(JsonConvert.SerializeObject(fileres), Encoding.UTF8, "application/json");
                response.Content.Headers.ContentDisposition = new ContentDispositionHeaderValue("attachment");
                response.Content.Headers.ContentType = new MediaTypeHeaderValue(GetfileContenttype(filelist.Filetype));
